...
import IndividualUniform from "./IndividualUniform";
...
function TradeFeedAof() {
    ...
    useEffect(() => {
        const getPoaList = async () => {
            const res = await fetch(`${baseUrl}/list-rta?page=1&per_page=${limit}`);
                        ...
                        <Grid sx={{ minWidth: 120 }}>
                            <FormControl fullWidth>
                                ...
                                >
                                    ...
                                    <MenuItem
                                        onClick={() => {
                                            setSelected("individualUniform");
                                        }}
                                        value="individualUniform"
                                    >
                                        individualUniform
                                    </MenuItem>
